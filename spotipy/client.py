...
class Spotify:
    ...
    def current_user_unfollow_playlist(self, playlist_id):
        ...
        Parameters:
            - name - the name of the playlist
        """
        return self._delete("playlists/%s/followers" % (playlist_id))
    ...
    def playlist_replace_items(self, playlist_id, items):
        ...
        return self._put("playlists/%s/tracks" % (plid), payload=payload)
    ...
    def playlist_is_following(self, playlist_id, user_ids):
        ...
        return self._get(endpoint.format(playlist_id, ",".join(user_ids)))
